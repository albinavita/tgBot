...
public class BotService extends TelegramLongPollingBot {
    ...
    /*Сюда будет вставлено значение из application.properties,
     в котором будет указан api key, полученный от BotFather
     */
    @Value("${bot.api.key}")
    ...
    /*Данный метод просто возвращает данные
    об имени бота и его необходимо переопределять*/
    @Override
